<div align="center">
  <p><sub>PRODUCT EXPLORATION · AI WORKFLOWS · DECISION SYSTEMS</sub></p>
  <h1>Hi, I'm William Chiu</h1>
  <p><strong>把模糊問題整理成可驗證的判斷，再把有效方法做成能重複使用的系統。</strong></p>
  <p>
    我關注產品探索、Agentic Workflow 與 AI 影音，<br>
...
```mermaid
flowchart LR
    A["投入工作與 Prototype 探索<br/>期待、任務變動與自我懷疑"]
    B["反覆修改，開始追問卡住的原因<br/>意圖、AI 轉譯，還是產品假設？"]
    C["準備向主管說明<br/>做了很多，卻還沒說清楚帶來什麼判斷"]
    D["接住回饋，重新理解 Ownership<br/>我負責到產出，還是結果？"]
    E["回頭整理這段經歷<br/>把當時想法、實驗與回饋接起來"]
    F["進入影片任務，再次面對交付<br/>理解了道理，做事方式仍需要改變"]
    A --> B --> C --> D --> E --> F
```
...
<table>
  <tr>
    <td>
      ...
      <p><sub>市場位置 → 模型吸收 → 可遷移技能 → 改判訊號</sub></p>
    </td>
  </tr>
</table>
